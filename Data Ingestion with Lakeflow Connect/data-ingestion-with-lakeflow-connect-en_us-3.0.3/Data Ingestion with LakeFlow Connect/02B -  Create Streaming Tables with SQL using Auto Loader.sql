...
FROM STREAM read_files(
  '/Volumes/dbacademy/labuser15029920_1778835559/csv_files_autoloader_source',
...
SELECT COUNT(*) FROM sql_csv_autoloader;

-- COMMAND ----------

SHOW TABLES IN dbacademy.labuser15029920_1778835559;
