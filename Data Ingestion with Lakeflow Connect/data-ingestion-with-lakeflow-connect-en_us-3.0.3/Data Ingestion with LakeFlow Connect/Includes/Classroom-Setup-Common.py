...
# MAGIC
# MAGIC CREATE SCHEMA IF NOT EXISTS labuser15029920_1778835559;
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS dbacademy.ops.meta (
# MAGIC     owner STRING,
# MAGIC     object STRING,
# MAGIC     key STRING,
# MAGIC     value STRING
...
# MAGIC %sql
# MAGIC DELETE FROM dbacademy.ops.meta;

# COMMAND ----------

# MAGIC %sql
# MAGIC INSERT INTO dbacademy.ops.meta VALUES
# MAGIC (
# MAGIC  'labuser15029920_1778835559@local',
# MAGIC  NULL,
# MAGIC  'username',
# MAGIC  'labuser15029920_1778835559@local'
# MAGIC ),
...
# MAGIC  NULL,
# MAGIC  'schema_name',
# MAGIC  'labuser15029920_1778835559'
# MAGIC ),
# MAGIC
# MAGIC (
# MAGIC  'labuser15029920_1778835559@local',
# MAGIC  NULL,
# MAGIC  'paths.working_dir',
# MAGIC  '/Volumes/dbacademy/ops/labuser15029920_1778835559_local'
# MAGIC ),
# MAGIC
# MAGIC (
# MAGIC  'labuser15029920_1778835559@local',
...
# MAGIC  'account users',
# MAGIC  NULL,
# MAGIC  'datasets.ecommerce',
# MAGIC  'dbacademy_ecommerce.v01'
# MAGIC ),
# MAGIC
# MAGIC (
# MAGIC  'account users',
# MAGIC  NULL,
# MAGIC  'paths.datasets.ecommerce',
# MAGIC  '/Volumes/dbacademy_ecommerce/v01'
# MAGIC );
...
# MAGIC
# MAGIC CREATE VOLUME IF NOT EXISTS labuser15029920_1778835559_local;
...
metadata_df = spark.table("dbacademy.ops.meta")
...
class DatasetPaths:
    ecommerce = metadata["paths_datasets_ecommerce"]

class Paths:
    working_dir = metadata["paths_working_dir"]
...
print("Academy-like environment initialized.")
print("Catalog:", DA.catalog_name)
print("Schema:", DA.schema_name)
print("Working Directory:", DA.paths.working_dir)
...
# MAGIC USE CATALOG dbacademy;
# MAGIC
# MAGIC USE SCHEMA labuser15029920_1778835559;
# MAGIC
